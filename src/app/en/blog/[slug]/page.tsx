...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://alcolab.org/en/blog/${post.slug}`,
    },
    openGraph: {
      title: post.title,
      description: post.description,
...
export default function BlogPostEN({ params }: Props) {
  ...
  const jsonLd = {
    ...
    mainEntityOfPage: `https://alcolab.org/en/blog/${post.slug}`,
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-[#002060] text-white py-6">
        <div className="max-w-3xl mx-auto px-4">
          <Link href="/en/blog" className="inline-flex items-center gap-2 text-sm text-blue-200 hover:text-white mb-3">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="mt-8 pt-6 border-t text-center">
          <p className="text-sm text-neutral-500 mb-3">
            Want to try AlcoLab? It's free and works in your browser.
          </p>
          <Link
            href="/app"
