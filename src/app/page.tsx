        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left space-y-6">
            ...
            <p className="text-xs text-neutral-400 italic">
              Ferramenta de triagem — não substitui análise laboratorial
              confirmatória.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-neutral-700 leading-relaxed">
                A partir da densidade relativa e de tabelas de referência
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-neutral-700 leading-relaxed">
                Combina densidade relativa e viscosidade relativa (corrigida para
      ...
      <section className="bg-white px-6 py-16 lg:px-16 lg:py-20">
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <p className="text-sm text-neutral-700 leading-relaxed text-justify">
            ...
            Monte Carlo) que avalia a incerteza experimental.
          </p>
          <p className="text-sm text-neutral-700 leading-relaxed text-justify">
