    ...
    sampleVideos: [
      {
        ...
        duration: 240,
        marks: computeMarks(214.8 * 1.0494 * 1.016, 7.00 * 1.0494 * 1.016),
        volumesMarked: [18, 17, 16, 15, 14] as Array<14 | 15 | 16 | 17 | 18>,
      },
      {
        ...
        duration: 240,
        marks: computeMarks(219.2 * 1.0494 * 1.016, 6.50 * 1.0494 * 1.016),
        volumesMarked: [18, 17, 16, 15, 14] as Array<14 | 15 | 16 | 17 | 18>,
      },
    ],
    manualTimesText: "Water: 103.9 and 104.9 seconds\nSample: 229.0 and 233.7 seconds",
    banners: {
    ...
    sampleVideos: [
      {
        ...
        duration: 240,
        marks: computeMarks(216.8 * 1.0344, 7.00 * 1.0344),
        volumesMarked: [18, 17, 16, 15, 14] as Array<14 | 15 | 16 | 17 | 18>,
      },
      {
        ...
        duration: 240,
        marks: computeMarks(223.5 * 1.0344, 6.50 * 1.0344),
        volumesMarked: [18, 17, 16, 15, 14] as Array<14 | 15 | 16 | 17 | 18>,
      },
    ],
    manualTimesText: "Water: 103.9 and 104.9 seconds\nSample: 224.3 and 231.2 seconds",
    banners: {
      sampleData: COMMON_BANNER_SAMPLE,
