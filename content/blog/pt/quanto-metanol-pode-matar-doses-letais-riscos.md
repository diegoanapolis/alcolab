...
[AlcoLab](https://alcolab.org) é um aplicativo web gratuito e de código aberto que permite detectar metanol em bebidas. Utiliza apenas uma seringa, uma balança de cozinha e um smartphone.
...
Em bebidas adulteradas, quantidades pequenas — um simples copo — podem ser fatais. A educação é essencial. Vigilância sanitária é essencial. Ferramentas como [AlcoLab](https://alcolab.org) são essenciais para proteger a população contra os riscos silenciosos do metanol.
