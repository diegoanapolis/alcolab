...
description: >-
  A free, open-source methanol screening app, self-funded from the ground up.
  The story of those who decided that contributing to public health mattered
...
The first option would be to propose the instruments used as a minimal physical device and initiate a patent application. It would be the safest path to protect the invention and eventually obtain a return on the invention, study, and work invested.

The problem was that there was an active outbreak, in Brazil and elsewhere. **People were being poisoned and some were losing their lives**. And the window between "ready idea" and "patent granted" could last years.

The second option was to launch immediately, for free, bearing the costs out of their own pockets — online server, domain, test materials, beverages for calibration — without any guarantee of return. They chose the latter.

## What "open source" means in practice

AlcoLab (Methanol screening app) was published under the **AGPL-3.0** license — one of the most rigorous open-source licenses available. It ensures that **any derivative version of the tool must also be open**, preventing third parties from turning the code into a proprietary product without making modifications available.
...
These registrations are not aimed at commercial exploitation, but rather the opposite. In this sense, they aim to prevent another person or company from claiming the idea as their own after it has already been made public. It is, therefore, a protection oriented toward openness, not closure.
...
On the other hand, free software (Methanol screening app) doesn't mean software without cost. It means someone is bearing it.

> In AlcoLab's case, that bill was — and still is — paid by us, the creators. Server hosting, domain registration, commercial beverages purchased for experimental tests, calibration materials, and many hours of research and work. Everything came out of the team's pocket, which worked for months without any external incentive.
...
This is possible while the stamina lasts. And the team is honest about the risks: *open source* projects without institutional support have a known history of burnout. Volunteer developers become overloaded, maintenance accumulates, updates stop being made, and the infrastructure becomes vulnerable. The result is what the field calls *abandonware* — software that exists, but no longer has anyone behind it.
...
| Result time | Hours to days | 15 – 25 min |
...
In about a month of the public website, AlcoLab (Methanol screening app for distilled beverages) registered nearly 2,500 unique visitors and approximately 34,000 server requests, with access from all continents — Brazil, United States, China, France, Canada, Singapore, and Switzerland, among others.
...
Internationally, Médecins Sans Frontières — which has maintained the *Methanol Poisoning Initiative* since 2012 —, PAHO/WHO, foundations such as Wellcome Trust and Gates Foundation, and organizations such as BID Lab and STDF have been contacted. Nationally, the list includes Fiocruz, MAPA, ANP, health surveillance, and parliamentarians. Moreover, in the field of research funding, there are planned submissions to FAPEMA, FINEP, and FAP-DF.
...
**The choice to open the code and launch for free was not painless.** It means giving up any direct return on the work done. It means continuing to bear the costs without knowing for how long. It means, therefore, **betting that collective impact is worth more than individual protection of the invention**.
...
This is not a manifesto. It's just what happened.
...
> If this project makes sense to you, the most direct way to help is to share it with those who could benefit — a consumer, a producer, an inspector, someone who works with food safety. And if you represent an institution that could support AlcoLab, or know someone who could, get in touch: [**alcolabapp@gmail.com**](mailto:alcolabapp@gmail.com)
